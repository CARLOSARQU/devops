...
public class LosAndesTransferSummaryPage extends BasePage {

    private static final Logger log = LogManager.getLogger(LosAndesTransferSummaryPage.class);
    ...
    public LosAndesTransferSummaryPage(AndroidDriver driver) { super(driver); }
    ...
    public LosAndesOtpPage clickContinue() {
        ...
        return new LosAndesOtpPage(driver);
    }
}
